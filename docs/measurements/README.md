...
could be designed at all. These are the write-ups, kept as evidence: the
numbers are unchanged from the day they were taken, and the ADRs in
[`../adr/`](../adr/) cite them.
...
The probe scripts behind these documents were throwaway experiments and are not
carried in the tree; the repository history has them. Timing benchmarks of the
