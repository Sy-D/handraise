...
real Solari API (the raw numbers live in [`spikes/`](../../spikes/)) and from the
pre-publish security review — they document the history, they do not invent it.

| # | Decision | Status | Grounded in |
|---|---|---|---|
| [0001](0001-websocket-live-view-transport.md) | WebSocket as the live-view transport | accepted | Spike S1 |
| [0002](0002-relay-in-solari-sandbox.md) | Run the relay in a Solari sandbox behind port-preview | accepted | Spikes S1, S4 |
| [0003](0003-no-keep-alive-five-minute-wait.md) | No browser keep-alive, 5-minute default wait, storageState capture | accepted | Spike S4 |
